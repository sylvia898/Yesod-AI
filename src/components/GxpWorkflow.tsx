    ...
    <section id="gxp" className="bg-white">
      <div className="mx-auto max-w-[1200px] px-6 py-24">
        <SectionHeading
          ...
          description="GxP — primarily GCP for trial data, GLP for analytical work — expects documented intent, qualified behavior, attributable actions, and reconstructable outputs. For SDTM, ADaM, and TLF workflows, that translates into eight engineering capabilities."
        />
