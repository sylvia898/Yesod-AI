    ...
    <section id="iq-oq-pq" className="bg-white">
      <div className="mx-auto max-w-[1200px] px-6 py-24">
        <SectionHeading
          ...
          description="The qualification spine of GxP software still applies — but the evidence changes when infrastructure is ephemeral and the system uses an LLM."
        />
